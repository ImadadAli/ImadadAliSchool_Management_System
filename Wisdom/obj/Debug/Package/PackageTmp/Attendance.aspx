            ...
            <div class="col-sm-5 pt-5 pe-5 align-items-end justify-content-center">
                <div class="p-5 mb-5 rounded" style="background-color: rgba(0, 0, 0, 0.5); box-shadow: 0 0 10px #000;">
                    ...
                    <div style="color: #FFFFFF;">
                        <div class="mb-3">
                                <asp:Label ID="lblAttendanceDate" runat="server" CssClass="form-label">Date</asp:Label>
                                <asp:TextBox ID="txtAttendanceDate" runat="server" TextMode="Date" CssClass="form-control mt-1"></asp:TextBox> 
                            </div>
                        <div class="mb-3">
