<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WisdomMaster.Master"
    CodeBehind="Result.aspx.cs" Theme="Theme1" Inherits="Wisdom.Result" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
  ...
  <center>
    ...
    <div class="container-fluid" style="background-image: url('Images/result.png'); background-repeat: no-repeat;
        ...
        <asp:View ID="View2" runat="server">
            <asp:DataList ID="dlFi" runat="server">
            <ItemTemplate>
    ...
    <tr><td class="style2" style="border:1px solid black">3</td>
        ...
        <td class="style3" style="border:1px solid black"><%#Eval("Gujarati") %></td>
    </tr>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><%#Eval("Obt_marks") %></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><%#Eval("Percentage") %></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        ...
        <asp:View ID="View3" runat="server">
            <asp:DataList ID="dlTh" runat="server">
    ...
    <tr><td class="style2" style="border:1px solid black">9</td>
        ...
        <td class="style3" style="border:1px solid black"><%#Eval("English_Gra") %></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><%#Eval("Obt_marks") %></td>
    </tr>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        ...
        <asp:View ID="View4" runat="server">
            <asp:DataList ID="dlSi" runat="server">
            <ItemTemplate>
            <table style="border:2px solid green">
    <tr>
    <td>    
    ...
    <tr><td class="style2" style="border:1px solid black">11</td>
        ...
        <td class="style3" style="border:1px solid black"><%#Eval("Science") %></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><%#Eval("Obt_marks") %></td>
    </tr>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        ...
        <asp:View ID="View5" runat="server">
            <asp:DataList ID="dlEi" runat="server">
            <ItemTemplate>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblObtEi" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblPerEi" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblGradeEi" runat="server"></asp:Label></td>
    </tr>
    </table>
    </td>
    </tr>
        ...
        <asp:View ID="View6" runat="server">
            <asp:DataList ID="dlNi" runat="server">
            <ItemTemplate>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblObtNi" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblPerNi" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblGradeNi" runat="server"></asp:Label></td>
    </tr>
    </table>
    </td>
    </tr>
    ...
    <asp:View ID="View7" runat="server">
        <asp:DataList ID="dlTe" runat="server">
        <ItemTemplate>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblObtTe" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblPerTe" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblGradeTe" runat="server"></asp:Label></td>
    </tr>
    </table>
    </td>
    </tr>
    ...
    <asp:View ID="View8" runat="server">
        <asp:DataList ID="dlSci" runat="server">
        <ItemTemplate>
            <table style="border:2px solid green">
    <tr>
    <td>    
    ...
    <tr><td class="style2" style="border:1px solid black">3</td>
        ...
        <td class="style3" style="border:1px solid black"><%#Eval("Phys") %></td>
    </tr>    
    <tr><td class="style2" style="border:1px solid black">4</td>
        <td class="style1" style="border:1px solid black;text-align:left">COMPUTER</td>
        <td class="style3" style="border:1px solid black"><%#Eval("Comp") %></td>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblObtSci" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblPerSci" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblGradeSci" runat="server"></asp:Label></td>
    </tr>
    </table>
    </td>
    </tr>
    ...
    <asp:View ID="View9" runat="server">
        <asp:DataList ID="dlArts" runat="server">
        <ItemTemplate>
    ...
    <tr><td class="style2" style="border:1px solid black">3</td>
        ...
        <td class="style3" style="border:1px solid black"><%#Eval("Psyc") %></td>
    </tr>    
    <tr><td class="style2" style="border:1px solid black">4</td>
    ...
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">Obtained Marks</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblObtArts" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">PER(%)</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblPerArts" runat="server"></asp:Label></td>
    </tr>
    <tr><td class="style1" colspan="2" style="border:1px solid black;text-align:center">GRADE</td>
        <td class="style3" style="border:1px solid black"><asp:Label ID="lblGradeArts" runat="server"></asp:Label></td>
    </tr>
    </table>
    </td>
    </tr>
